...
// CanonicalAcademicUnitSeed is the initial NITC Resource Vault academic-unit catalog.
// Keep display names separate from stable codes so presentation changes do not break IDs.
