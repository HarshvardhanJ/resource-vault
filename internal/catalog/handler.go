...
func (h *Handler) HandleHome(w http.ResponseWriter, r *http.Request) {
	...
	h.renderer.Render(w, "home.html", map[string]interface{}{
		"Title": "NITC Resource Vault — Public Academic Archive",
		"Branches": branches, "RecentPYQs": recent, "TotalCourses": totalCourses,
	})
}
...
func (h *Handler) HandleBranch(w http.ResponseWriter, r *http.Request) {
	...
	h.renderer.Render(w, "branch.html", map[string]interface{}{"Title": branch.Code + " — " + branch.Name, "Branch": branch, "Courses": courses})
}
...
func (h *Handler) HandleCourse(w http.ResponseWriter, r *http.Request) {
	...
	h.renderer.Render(w, "course.html", map[string]interface{}{
		"Title": course.Code + " — " + course.Name, "Course": course, "Resources": resList,
		"SelectedExamType": examType, "SelectedSemester": semester, "SelectedYear": yearStr,
	})
}
...
func (h *Handler) HandleEditCourse(w http.ResponseWriter, r *http.Request) {
	...
	h.renderer.Render(w, "course_edit.html", map[string]interface{}{"Title": "Edit " + course.Code + " — NITC Resource Vault", "Course": course, "Branches": allBranches, "MappedBranchMap": mapped})
}
...
func (h *Handler) HandleNewCourse(w http.ResponseWriter, r *http.Request) {
	...
	h.renderer.Render(w, "course_new.html", map[string]interface{}{"Title": "Add New Course — NITC Resource Vault", "Branches": allBranches, "MappedBranchMap": mapped, "Preselected": preselect})
}
